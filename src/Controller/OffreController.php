...
class OffreController extends AbstractController
{
    ...
    public function pdfpos($id, OffreRepository $r, offreService $pdf, ManagerRegistry $doctrine)
    {
    ...
    public function sendEmail($id, ManagerRegistry $doctrine): Response
    {
        ...
        $email = (new Email())
            ...
            ->attachFromPath('assets/pdf/offre.pdf');
    ...
    #[Route('/statsoffre', name: 'statsoffre')]
    public function statistique(CategoriesRepository $cat)
    {
        ...
        return $this->render('adminoffre/stats.html.twig', [
