...
public class AjouterNotification extends Form {
    ...
    public AjouterNotification(Form previous) {
    ...
    private void addActions() {
        ...
        manageButton.addActionListener(action -> {
            if (controleDeSaisie()) {
                int responseCode = NotificationService.getInstance().add(
                        new Notification(
                ...
                if (responseCode == 200) {
                    Dialog.show("Succés", "Notification ajouté avec succes", new Command("Ok"));
                    showBackAndRefresh();
                } else {
                    Dialog.show("Erreur", "Erreur d'ajout de notification. Code d'erreur : " + responseCode, new Command("Ok"));
                }
            }
        });
    }
